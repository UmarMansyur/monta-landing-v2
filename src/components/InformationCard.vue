        ...
        <div class="grid items-center lg:grid-cols-12 gap-6 lg:gap-12">
          ...
          <div
            ...
            <div class="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
              <div>
                <p class="text-6xl md:text-4xl lg:text-6xl font-bold text-blue-600">99+</p>
                <p class="mt-1 text-gray-500">Pengunjung Bulan Ini</p>
              </div>
              <div>
                <p class="text-6xl md:text-4xl lg:text-6xl font-bold text-blue-600">144+</p>
                <p class="mt-1 text-gray-500">Proposal Penelitian di Ajukan</p>
              </div>
              <div>
                <p class="text-6xl md:text-4xl lg:text-6xl font-bold text-blue-600">50+</p>
                <p class="mt-1 text-gray-500">Proposal Selesai Di Review</p>
              </div>
            </div>
          </div>
        </div>
