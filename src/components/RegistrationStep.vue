<template>
    <section>
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-10 mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:gap-10 sm:gap-5 py-10">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <h2 class="text-xl font-bold text-black-100 my-3 text-center">Memprogram KRS KP/TA</h2>
                </div>
                <div class="flex flex-col items-center justify-center">
                    ...
                    <h2 class="text-xl font-bold text-black-100 my-3 text-center">
