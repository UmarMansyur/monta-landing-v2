...
<footer class="">
    <div class="mx-auto w-full container px-5 mt-auto lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Universitas Madura</a>. All Rights Reserved.
          </span>
