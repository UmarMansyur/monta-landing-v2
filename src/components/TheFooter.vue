<template>
    <footer class="mt-auto bg-[#001c3b] text-white py-10">
                        ...
                        <div
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" id="hero-input" name="hero-input"
                                    class="py-3 px-4 block w-full text-gray-800 placeholder-gray-400 rounded-lg focus:ring-0 focus:outline-none"
